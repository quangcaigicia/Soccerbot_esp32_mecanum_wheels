...
Motor motor1(14, 12, 13, 1); // Direction pin and pwm channel for motor A
Motor motor2(26, 27, 25, 2); // Direction pin and pwm channel for motor B
Motor motor3(21, 32, 33, 3); // Direction pin and pwm channel for motor C
Motor motor4(5, 18, 19, 4);  // Direction pin and pwm channel for motor C
...
void loop()
{
    ...
    if (Dabble.isAppConnected())
    {
        ...
        else // Joystick mode
        {
            ...
            motor1.set_motor_omnidirectional(x, y, 0, 0, -6, 6, 128, -255, 255, 1);
            motor2.set_motor_omnidirectional(x, y, 0, 0, -6, 6, 128, -255, 255, 2);
            motor3.set_motor_omnidirectional(x, y, 0, 0, -6, 6, 128, -255, 255, 3);
            motor4.set_motor_omnidirectional(x, y, 0, 0, -6, 6, 128, -255, 255, 4);
